...
$$
m_\text{Sekante} = \frac{f(x_2) - f(x_1)}{x_2 - x_1} = \frac{\Delta y}{\Delta x}.
$$
```

Die folgende Abbildung zeigt den Graphen einer Beispielfunktion mit einer
eingezeichneten Sekante. Mit dem Schieberegler können wir den zweiten Punkt
variieren und sehen, wie sich die Steigung der Sekante ändert.

```{admonition} Interaktive Demo
:class: hint
> [Starte Applet: Sekante - Tangente](https://gramschs.github.io/thm_anm_de_assets/interactive/chapter04/sekante-tangente-svg.html)
```
